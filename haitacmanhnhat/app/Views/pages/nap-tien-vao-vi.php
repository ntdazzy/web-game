...
$pageStyles[] = '/assets/css/modules/payments.css';
?>
<!-- End Meta Chung -->
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="payment w-100">
                    <ul class="payment-tab w-100">
                        <li class="link-to-payment active"><a href="/nap-tien-vao-vi">Nạp tiền vào ví</a></li>
                        <li class="link-to-package"><a href="/qua-nap-web">Quà nạp web</a></li>
                    ...
                    <div class="item-list w-100">
                        ...
                        <div class="item-list-payment-type">
                            <a class="item-type active" data-bonus="0.2" data-rate="50" href="javascript: void(0)">
                                ...
                                <div class="img img-type-3 payment-icon payment-icon--momo"></div>
                                <h6>Ví MoMo</h6>
