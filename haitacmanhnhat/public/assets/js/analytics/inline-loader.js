(function (window, document) {
  var analyticsEnabled = typeof window.__ENABLE_ANALYTICS__ === 'undefined' ? true : !!window.__ENABLE_ANALYTICS__;
  if (!analyticsEnabled) {
    return;
  }
  ...
  if (typeof domainSource !== 'string' || domainSource.trim() === '') {
    domainSource = typeof window.__PRIMARY_DOMAIN__ === 'string' && window.__PRIMARY_DOMAIN__.trim() !== ''
  ...
  var cookieDomain = typeof window.cookieDomain === 'string' && window.cookieDomain !== ''
    ? window.cookieDomain
