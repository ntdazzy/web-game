            ...
            <ul class="collapse menu-mobile position-absolute" id="mobileMenu">
                ...
                <li class="menu-mobile-bottom">
                    ...
                    <ul class="collapse social row collapse-normal" id="20">
                        <li class="d-flex justify-content-center col-4">
                            <a class="dropdown-item" href="https://www.facebook.com/haitacmanhnhat" target="_blank" rel="noopener">Facebook</a>
                        </li>
                        <li class="d-flex justify-content-center col-4">
                            <a class="dropdown-item" href="https://discord.com/invite/pRQaVmUj78" target="_blank" rel="noopener">Discord</a>
                        </li>
                        <li class="d-flex justify-content-center col-4">
                            <a class="dropdown-item" href="https://zalo.me/g/snnzqo202" target="_blank" rel="noopener">Zalo</a>
                        </li>
                    </ul>
                </li>
                <li class="menu-mobile-bottom">
                    ...
                    <ul class="collapse social row collapse-normal collapse-community" id="30">
                        <li class="d-flex justify-content-center col-4 youtube">
                            <a class="dropdown-item" href="https://www.youtube.com/@haitacmanhnhat" target="_blank" rel="noopener">Youtube</a>
                        </li>
                        <li class="d-flex justify-content-center col-4 group">
                            <a class="dropdown-item" href="https://www.facebook.com/groups/dechehaitac" target="_blank" rel="noopener">Group cộng đồng</a>
                        </li>
                        <li class="d-flex justify-content-center col-4 tiktok">
                            <a class="dropdown-item" href="https://www.tiktok.com/@haitacmanhnhat" target="_blank" rel="noopener">Tiktok</a>
                        </li>
