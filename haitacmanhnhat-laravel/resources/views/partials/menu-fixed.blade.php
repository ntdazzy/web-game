    ...
    <div class="position-relative">
        <div class="right-menu position-absolute">
            <ul class="menu-group">
                ...
                <li class="menu-item">
                    <a href="{{ route('giftcode') }}" target="_self">Nhận code</a>
                </li>
                <li class="menu-item social d-flex row m-0">
                    <div class="col-12 d-flex flex-wrap justify-content-center">
                        <a class="facebook" href="https://www.facebook.com/haitacmanhnhat" target="_blank" rel="noopener">Facebook</a>
                        <a class="tiktok" href="https://www.tiktok.com/@haitacmanhnhat" target="_blank" rel="noopener">Tiktok</a>
                        <a class="youtube" href="https://www.youtube.com/@haitacmanhnhat" target="_blank" rel="noopener">Youtube</a>
                        <a class="group" href="https://www.facebook.com/groups/dechehaitac" target="_blank" rel="noopener">Facebook group</a>
                        <a class="discord" href="https://discord.com/invite/pRQaVmUj78" target="_blank" rel="noopener">Discord</a>
                        <a class="zalo" href="https://zalo.me/g/snnzqo202" target="_blank" rel="noopener">Zalo</a>
                    </div>
                </li>
            </ul>
