        ...
        <div class="user-info h-100 d-flex align-items-center d-none">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-item d-flex align-items-center"><a href="{{ route('home') }}"><i class="fa-light fa-right-from-bracket"></i>Đăng xuất</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="payment w-100">
                    <ul class="payment-tab w-100">
                        <li class="link-to-payment"><a href="{{ route('payments.wallet') }}">Nạp tiền vào ví</a></li>
                        <li class="link-to-package"><a href="{{ route('payments.packages') }}">Quà nạp web</a></li>
                        <li class="link-to-convert active"><a href="{{ route('payments.convert') }}">Từ ví vào game</a></li>
                    </ul>
                    <!-- End Tab Menu Chung -->
                    ...
                    <div class="link-to-history w-100 text-center"><a class="login-required" data-open-auth="login" data-redirect="{{ route('payments.packages') }}" href="{{ route('payments.history') }}">Lịch sử nạp</a></div>
                    <div class="server-list w-100">
                        <select class="form-control payment-server" name="fserver">
                            <option value=""></option>
