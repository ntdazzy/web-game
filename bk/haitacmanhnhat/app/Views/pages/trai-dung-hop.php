...
$meta = [
    ...
    'og:title' => 'Trái dung hợp | Hải Tặc Mạnh Nhất',
...
$pageHeadScripts[] = '/assets/js/data/devil-fruits-fusion-data.js';
$pageScripts[] = '/assets/js/pages/fruits.js';
?>
...
<div class="d-flex flex-column align-items-center w-100 position-relative" id="root"
    data-devil-fruit-source="fusion" data-devil-fruit-json="/assets/data/trai-dung-hop.json">
