            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="payment w-100">
                    <ul class="payment-tab w-100">
                        ...
                        <li class="link-to-package active"><a href="{{ route('payments.packages') }}">Quà nạp web</a></li>
                        <li class="link-to-convert"><a href="{{ route('payments.convert') }}">Nạp từ ví vào game</a></li>
                    </ul>
                    <!-- End Tab Menu Chung -->
