@php
    ...
    $pageStyles = array_merge($pageStyles ?? [], ['assets/css/modules/giftcode.css']);
    $pageScripts = array_merge($pageScripts ?? [], ['assets/js/pages/giftcode.js']);
    $bodyAttributes = 'class="wrapper-subpage overflow-y-auto"';
    $giftcodeHistoryTables = $giftcodeHistoryTables ?? [
        [
            'id' => 'table-his-1',
            'content' => '<p>Test</p>',
            'items' => [],
