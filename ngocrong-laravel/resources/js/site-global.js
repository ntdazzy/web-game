        ...
        setTimeout(() => {
            ...
            itMe.done(function (response) {
                ...
                if (response.data.email == "Chưa xác thực") {
                    ...
                    if (form.length > 0) {
                        form.find('input[name="stepUpdateEmail"]').val(
                            UPDATE_MAIL_STEP_1
                        );
                        ...
                        form.on("submit", function (e) {
                            ...
                            if (!email) {
                                error("Nhập email");
                                form.find('input[name="email"]').addClass(
                                    "is-invalid"
                                );
                                return false;
                            } else {
                                form.find('input[name="email"]').removeClass(
                                    "is-invalid"
                                );
                            }
                    ...
                    if (form.length > 0) {
                        form.find('input[name="stepChangeEmail"]').val(
                            UPDATE_MAIL_STEP_1
                        );
                        ...
                        form.on("submit", function (e) {
                            ...
                            var oldemail = form
                                .find('input[name="oldemail"]')
                                .val();
                            if (!oldemail) {
                                error("Nhập email cũ");
                                form.find('input[name="oldemail"]').addClass(
                                    "is-invalid"
                                );
                                return false;
                            } else {
                                form.find('input[name="oldemail"]').removeClass(
                                    "is-invalid"
                                );
                            }
                            var oldemail = form
