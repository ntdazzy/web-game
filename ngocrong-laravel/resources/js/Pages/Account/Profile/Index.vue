...
const defaultAvatar = new URL('../../../assets/images/avatar.png', import.meta.url).href;
const avatarUrl = computed(() => props.profile?.avatar || defaultAvatar);

const genderLabel = computed(() => props.profile?.gender_label ?? 'Không xác định');
const birthdayLabel = computed(() => props.profile?.birthday ?? 'Chưa cập nhật');
                        ...
                        <div class="row content">
                            <div class="col-3 wrap-left-side">
                                <ul class="left-side">
                                    ...
                                    >
                                        <component :is="link.disabled ? 'span' : Link" :href="link.href">
                                            {{ link.label }}
                                        </component>
                                    </li>
                                </ul>
                            ...
                            <div class="col-9 user-box">
                                <div class="breadcrumb d-flex flex-column">
                                    ...
                                    <p>
                                        Bạn có thể cập nhật các thông tin công khai tại đây, hệ thống sẽ tự động kết nối với
                                        các tài khoản game khác
                                    </p>
                                    <div class="alert alert-warning mb-1 user-info-warning" role="alert">
                                        Để bảo mật tài khoản của bạn, hãy sớm cập nhật đầy đủ thông tin cá nhân để đảm bảo quyền
                                        lợi cho bạn!
                                    </div>
                                </div>
                                <div class="user-table">
                                    ...
                                    >
                                        <div class="col-4 label-text d-flex align-items-center">
                                            <i :class="row.icon"></i>
                                            {{ row.label }}
                                        </div>
                                        <div class="col-6 value-text">
                                        ...
                                        <div class="col-2 text-center p-0">
                                            <a v-if="row.action" :href="row.action" class="action-link">Cập nhật</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
