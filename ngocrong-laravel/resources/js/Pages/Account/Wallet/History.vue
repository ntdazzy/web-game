                    ...
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="history w-100">
                            <div class="form-history w-100">
                                <div class="row">
                                    <div
                                        class="form-item col-xxl-6 col-xl-6 col-lg-6 col-md-12"
                                    >
                                        <input
                                            type="text"
                                            name="fdatetime"
                                    ...
                                    <div
                                        class="form-item col-xxl-3 col-xl-3 col-lg-3 col-md-6"
                                    >
                                        <button
                                            type="button"
                                            name="fhistory"
                                ...
                                >
                                    <tbody v-if="hasTransactions">
                                        ...
                                        >
                                            <td class="text-start">
                                                <div
                                                    class="history-title fw-semibold"
                                                >
                                                    {{
                                                        typeLabel(
                                                            transaction.type
                                            ...
                                            <td class="text-end">
                                                <div
                                                    class="history-amount fw-semibold"
                                                >
                                                    {{
                                                        formatCurrency(
                                                            transaction.amount
                                                ...
                                                <div
                                                    class="history-status text-muted"
                                                >
                                                    {{
                                                        statusLabel(
                                                            transaction.status
