        ...
        <div class="container d-flex w-100 h-100">
            <div class="logo position-relative h-100">
                <div class="wrap-logo position-absolute d-flex flex-column align-items-center">
                    <a href="{{ route('home') }}">
                        <img src="{{ Vite::asset('resources/assets/images/logo.png') }}" alt="Hải Tặc Mạnh Nhất" class="logo-img">
                    </a>
                </div>
            </div>
            <div class="nav-bar position-relative">
                <img src="{{ Vite::asset('resources/assets/images/menu/bg-menu-nav.png') }}" alt="" class="position-absolute top-0">
                <ul class="main-nav d-flex h-100">
                    ...
                    <li class="d-flex justify-content-center align-items-center hero-item{{ $activeClass('heroes.index') }}">
                    ...
                    <li class="d-flex justify-content-center align-items-center fruit">
                        <a class="nav-item h-100 d-flex align-items-center" href="{{ route('fruits.index') }}" title="Trái Ác Quỷ" data-bs-toggle="dropdown">
    ...
    <div class="top-nav-mobile w-100 position-fixed d-none">
        ...
        <ul class="btn-group d-flex align-items-center position-relative">
            ...
            <li class="position-relative">
                <button class="btn swap-menu-id" type="button" data-bs-toggle="collapse" data-bs-target="#mobileMenu" aria-expanded="false" aria-controls="mobileMenu">
                    <span class="visually-hidden">Mở menu</span>
                </button>
                <ul class="collapse menu-mobile position-absolute" id="mobileMenu">
                    <li class="nav-item">
                        <a class="nav-link homepage{{ $activeClass('home') }}" href="{{ route('home') }}" title="Trang chủ" data-bs-target="#1" aria-expanded="false" aria-controls="1">
                            Trang chủ
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link news{{ $activeClass('news.*') }}" href="{{ route('news.index') }}" title="Tin tức" data-bs-target="#2" aria-expanded="false" aria-controls="2">
                            Tin tức
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link hero-item{{ $activeClass('heroes.index') }}" href="{{ route('heroes.index') }}" title="Tướng" data-bs-target="#3" aria-expanded="false" aria-controls="3">
                            Tướng
                        </a>
                    </li>
                    <li class="menu-mobile-bottom">
                        <a class="btn btn-link position-relative fruit" href="{{ route('fruits.index') }}" title="Trái Ác Quỷ" data-bs-toggle="collapse" data-bs-target="#mobileFruit" aria-expanded="false" aria-controls="mobileFruit">
                    ...
                    <li class="menu-mobile-bottom">
                        <a class="btn btn-link position-relative collapsed support" href="#" title="Hỗ trợ" data-bs-toggle="collapse" data-bs-target="#mobileSupport" aria-expanded="false" aria-controls="mobileSupport">
                            Hỗ trợ<i class="dropdown-icon position-absolute"></i>
                        </a>
                        <ul class="collapse social row collapse-normal" id="mobileSupport">
                            <li class="d-flex justify-content-center col-4">
                                <a href="https://www.facebook.com/haitacmanhnhat" target="_blank" rel="noopener" class="dropdown-item">Facebook</a>
                            </li>
                            <li class="d-flex justify-content-center col-4">
                                <a href="https://discord.com/invite/pRQaVmUj78" target="_blank" rel="noopener" class="dropdown-item">Discord</a>
                            </li>
                            <li class="d-flex justify-content-center col-4">
                                <a href="https://zalo.me/g/snnzqo202" target="_blank" rel="noopener" class="dropdown-item">Zalo</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-mobile-bottom">
                        ...
                        <ul class="collapse social row show collapse-normal collapse-community" id="mobileCommunity">
                            <li class="d-flex justify-content-center col-4 youtube">
                                <a href="https://www.youtube.com/@haitacmanhnhat" target="_blank" rel="noopener" class="dropdown-item">Youtube</a>
                            </li>
                            <li class="d-flex justify-content-center col-4 group">
                                <a href="https://www.facebook.com/groups/dechehaitac" target="_blank" rel="noopener" class="dropdown-item">Group cộng đồng</a>
                            </li>
                            <li class="d-flex justify-content-center col-4 tiktok">
                                <a href="https://www.tiktok.com/@haitacmanhnhat" target="_blank" rel="noopener" class="dropdown-item">Tiktok</a>
                            </li>
